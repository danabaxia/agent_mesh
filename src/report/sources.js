...
// Fetches a generous recent window of PRs/issues; date-window filtering is the
// pure core's job (aggregate() buckets by the report day), so no date arg here.
export async function fetchGhActivity({ gh, repo }) {
