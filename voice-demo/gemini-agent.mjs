...
const SYSTEM = [
  ...
  '- DELIVER NOW, never defer: if you say you will analyze / explain / check / 帮你看 something, give the actual content IN THIS SAME reply. NEVER split it across turns, and NEVER ask "您准备好了吗 / 可以吗 / 要我说吗" before delivering — just deliver it. "好的我来分析…" with no analysis is a failure.',
